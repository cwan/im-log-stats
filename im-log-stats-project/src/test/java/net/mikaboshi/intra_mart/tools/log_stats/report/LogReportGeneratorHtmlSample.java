...
public class LogReportGeneratorHtmlSample {
	...
	public static void main(String[] args) throws IOException {
		...
		reportParameter.setSignature("LogReportGeneratorHtmlSample");
		generator.setReportParameter(reportParameter);

		TemplateFileReportFormatter reportFormatter = new TemplateFileReportFormatter(
															new File("temp/report.html"),
															"Windows-31J",
															parserParameter,
															reportParameter);
